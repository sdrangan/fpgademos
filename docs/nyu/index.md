...
For NYU MS students, the class will be offered as *ECE-GY 6463:  Advanced Hardware Design*.  Although the course title has "advanced" in it, do not be scared if you have no hardware experience.  It just has that name for historical reasons that prior versions assumed undergraduate experience in hardware.  You do not need any hardware experience -- see the Prerequesities section below.  The advanced is only referring now to the fact that it is intended for MS student who can learn material at a fast pace.  Also, an initial version of this class was offered in Spring 2026
